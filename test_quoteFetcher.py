...
class TestQuoteFetcher(TestCase):
    def test_InvestopediaUrl(self):
        ...
        expected_url = 'https://www.investopedia.com/markets/api/partial/historical/?Symbol=MSFT&Type=Historical+Prices' \
                       '&Timeframe=Daily&StartDate=Nov+28%2C+2017&EndDate=Dec+05%2C+2017'
